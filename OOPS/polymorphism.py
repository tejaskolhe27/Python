...
class SalariedEmp(Employee,ABC):
    ...
    def calculatesalary(self):
        return (self.__sal+(0.10*self.__sal)+(0.12*self.__sal)-(0.08*self.__sal))
    
class ContractEmp(Employee,ABC):
...
if __name__=="__main__":
    ...
    print(s)
    print("Salary is: ", s.calculatesalary())
    print(c)
    print("Salary is: ", c.calculatesalary())